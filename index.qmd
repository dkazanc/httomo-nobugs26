...
conda install -c conda-forge pytest pytest-cov pytest-xdist pytest-mock plumbum
```
...
```bash
python -m httomo run tomodata_synth.nxs pipeline_synth.yaml output/
```
...
### Reconstructing `[1800, 200, 2560]` data chunk on Nvidia V100.
